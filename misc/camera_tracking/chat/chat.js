    ...
    $(document).keydown(function(e){
        if (e.keyCode === 13){ //Enter
            ...
            var cameraCommandIndex = Math.max(
                ...
                chatBoxInput.toLowerCase().indexOf("/clear"),
                chatBoxInput.toLowerCase().indexOf("/del"),
                chatBoxInput.toLowerCase().indexOf("/mv"),
                chatBoxInput.toLowerCase().indexOf("/edit"),
                chatBoxInput.toLowerCase().indexOf("/interval"),
                ...
                chatBoxInput.toLowerCase().indexOf("/camera"),
                chatBoxInput.toLowerCase().indexOf("/replay"),
            );
            if (cameraCommandIndex == 0) {
                dew.notify("camera-action", { action: chatBoxInput.toLowerCase() });
                chatboxHide();
                $("#chatBox").val("");
                return;
            }
...
dew.on("chat", function(e){
    ...
    if(e.data.chatType == "SERVER" || e.data.chatType == "DEBUG")
